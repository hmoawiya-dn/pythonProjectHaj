...
versionLink = 'http://minioio.dev.drivenets.net:9000/dnor/comet-dnor-eng-15.0.1/dnor_eng.15.1.0.2-8940c7856a.tar'
dnorVersion = "V15"
config = Config(dnor='dn49cd')
...
def test08_Generating_DNORcfg_File_for_Primary_DNOR():
    ...
    cfgfile.read('venv/installCustomerDNORS/CustomerFiles/NTT/dnor.cfg')
...
def test16_add_images_to_DNOR():
    global authorizationToken
    images = open(f'venv/installCustomerDNORS/CustomerFiles/NTT/images/images.json')
